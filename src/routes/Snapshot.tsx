...
/** SNAPSHOT (founder 2026-08-11) — "Share with me everything about who you
...
export default function Snapshot() {
  ...
  // Where 'manual mode' is — the builder they stepped out of (founder
  // 2026-08-11: the way back is how someone new to AI stays unafraid).
  const [params] = useSearchParams();
  const back = params.get('back') || '/profile#public-page';
  ...
  if (applied) {
    return (
      <div className="snap">
        <h1 className="snap__title">That&rsquo;s yours now.</h1>
  ...
  return (
    <div className="snap">
      <button className="snap__back" onClick={() => navigate(back)}>
        <Icon name="chevron-left" size={13} /> Back to manual mode
      </button>
      <h1 className="snap__title">Build your presence</h1>
      <p className="snap__lead">
