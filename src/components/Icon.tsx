...
const ICONS: Record<IconName, IconEntry> = {
  ...
  // The glyph's own enclosing circle was REMOVED 2026-08-31 (founder: "the
  // community logo still has 2 circles, versus just the two people in the
  // big circle") — inside the TopBar's ring it read as a circle inside a
  // circle, the exact thing the 2026-08-21 mark rule retired. Just the two
  // people now; the ring around them is whatever surface they sit on.
  // strokeWidth retuned to keep the same apparent weight in the tighter box.
  'user-multiple': {
    // Measured with getBBox (the check:icons discipline): artwork bounds
    // 186.28,526.49 → 7.71×6.92, squared and centred with 0.15 padding.
    viewBox: '186.133 525.949 8.012 8.012',
    strokeWidth: 0.5,
