...
export default function OfferingChips({ meta, lessonCount }: { meta: OfferingMeta; lessonCount?: number }) {
  ...
  else if (lessonCount != null) chips.push({ key: 'length', label: `${lessonCount} lesson${lessonCount === 1 ? '' : 's'}` });
